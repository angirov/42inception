...
if [ ! -f /var/www/html/wp-config.php ]; then
    ...
    wp core install --url=$DOMAIN_NAME --title="${SITE_NAME}" --admin_user=$WP_ADMIN_USER --admin_password=$WP_ADMIN_PASSWORD --admin_email=$WP_ADMIN_EMAIL --path=/var/www/html --allow-root
